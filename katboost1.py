...
print("Combined:", baseline_combined)
...
best_t, best_acc, best_rec, best_score = find_best_accuracy_recall_threshold(
    y_test, y_proba
)
...
# =========================================================
# 7. CONFUSION MATRIX — OPTIMAL MODEL
# =========================================================
...
# =========================================================
# 8. RISK GROUPS (95% recall + F1 thresholds)
# =========================================================
...
df_risk["risk_group"] = np.select(
    ...
    ["High", "Medium", "Low"],
    default="Low"        # *** vigtigt: default er en STRING ***
).astype(str)            # *** sikrer at numpy aldrig fejler ***
...
# ---- CONFUSION MATRIX FOR RISK GROUPS ----
cm_risk = pd.crosstab(
    df_risk["risk_group"],
    df_risk["DIED"],
