...
# Keep only COVID-positive (1,2,3)
...
# =========================================================
# 3. TRAIN/VAL/TEST (80/10/10 split)
# =========================================================
...
# =========================================================
# 5. BASELINE EVALUATION @ threshold = 0.5
# =========================================================
...
# =========================================================
# BASELINE: ACCURACY + RECALL KOMBINATION
# =========================================================
...
print(f"Combined score: {baseline_combined:.4f}")
...
def find_threshold_for_recall(y_true, y_proba, target=0.95):
    ...
    best_t, best_diff, best_recall = 0, 999, 0
...
# =========================================================
# 6B. BEST ACCURACY + RECALL THRESHOLD (ADDED)
# =========================================================
...
print("\n=== BEST ACCURACY + RECALL THRESHOLD ===")
...
# =========================================================
# CONFUSION MATRIX — BEST ACC + RECALL THRESHOLD
# =========================================================
...
print(f"95% recall threshold (Low→Risk): {t95:.4f}")
print(f"F1 threshold (Med→High):        {t_f1:.4f}")
print(f"Low < {low_thr:.4f},  Medium < {high_thr:.4f},  High ≥ {high_thr:.4f}")
...
# =========================================================
# 9. DEATH CAPTURE CHECK
# =========================================================
total_dead = df_risk["DIED"].sum()

dead_in_risk = df_risk[(df_risk["DIED"] == 1) &
                       (df_risk["risk_group"].isin(["Medium", "High"]))].shape[0]


dead_in_high = df_risk[(df_risk["DIED"] == 1) &
                       (df_risk["risk_group"] == "High")].shape[0]

print("\n=== DEATH CAPTURE ===")
print(f"Total deaths:            {total_dead}")
print(f"Deaths in MED+HIGH:      {dead_in_risk}")
print(f"Share captured (MED+HIGH): {dead_in_risk / total_dead:.3f}")
print(f"Deaths in HIGH:          {dead_in_high}")
print(f"Share captured (HIGH):   {dead_in_high / total_dead:.3f}")

# =========================================================
# 17. CONFUSION MATRIX FOR RISK GROUPS
# =========================================================
cm = pd.crosstab(df_risk["risk_group"], df_risk["DIED"],
